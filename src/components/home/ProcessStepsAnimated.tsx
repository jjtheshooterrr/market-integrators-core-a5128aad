  ...
  return (
    <section className="relative w-full py-10 md:py-14 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 text-center mb-6 md:mb-10">
        ...
        >
          Our Digital Growth Methodology
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
...
function Pill({
  ...
  return (
    <div className="shrink-0 inline-flex items-center gap-2 md:gap-2.5 rounded-xl border px-3 md:px-4 py-2 text-xs md:text-sm bg-card border-border hover:shadow-sm">

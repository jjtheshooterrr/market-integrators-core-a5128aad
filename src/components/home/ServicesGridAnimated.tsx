        ...
        <div className="industry-card-content">
          ...
          <div className="industry-card-back">
            <div className="industry-back-content">
              <h3 className="font-heading font-bold text-base mb-3 text-center px-4">{industry.title}</h3>
              <p className="text-xs text-center leading-relaxed px-4">{industry.description}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const industries = [
    {
      ...
      description:
        "From DTC brands to large-scale online stores, we build and optimize omni-channel campaigns that drive consistent ROI.",
    },
    {
      icon: AppWindow,
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant, precision-targeted digital campaigns that build trust and drive appointment growth.",
    },
    {
      icon: Gavel,
    ...
    },
    {
      ...
      description:
        "Helping tech and AI companies build brand presence and scale inbound through AI-assisted marketing.",
    },
  ];
  ...
  return (
    <section className="section-padding bg-secondary overflow-hidden">
      <div className="container-custom">
        ...
        >
          <h2 className="mb-4">Industries We Transform with Digital Solutions</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Integrated technology, marketing, and creative solutions tailored to your industry's unique challenges and growth opportunities.
          </p>
        </motion.div>

        <div className="carousel-3d">
          {industries.map((industry, index) => (
            <IndustryCarouselCard key={index} industry={industry} index={index} total={industries.length} />
          ))}
        </div>
        ...
        >
          <Link to="/industries" className="inline-flex items-center text-primary font-semibold hover:underline">
            View All Industries →
          </Link>
        </motion.div>
      </div>

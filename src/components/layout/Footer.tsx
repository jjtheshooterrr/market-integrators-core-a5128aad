        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="tel:+1234567890" className="flex items-center space-x-2 text-dark-foreground/80 hover:text-primary transition-colors">
                <Phone size={18} />
                <span>(123) 456-7890</span>
              </a>
              <a href="mailto:info@marketintegrators.com" className="flex items-center space-x-2 text-dark-foreground/80 hover:text-primary transition-colors">
                <Mail size={18} />
        ...
        <div className="border-t border-dark-foreground/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link to="/privacy-policy" className="text-dark-foreground/60 hover:text-primary text-sm transition-colors">
                Privacy Policy
              </Link>
              <Link to="/terms-of-service" className="text-dark-foreground/60 hover:text-primary text-sm transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>

...
import aprenovationsMacbook from "@/assets/aprenovations-macbook.webp";
        ...
        <section className="section-padding bg-gradient-to-b from-secondary/50 to-background">
          <div className="container-custom max-w-5xl text-center">
            ...
            <div className="mb-8 flex justify-center">
              <img
                src={aprenovationsLogo}
                alt="A&P Renovations logo"
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto mb-12 leading-relaxed">
              A full digital refresh—modern web design, local SEO, and lead capture systems that
              tripled quote requests and pushed A&P Renovations into Ogden's top local search
              results.
            </p>
        ...
        <section className="section-padding bg-secondary/30">
          <div className="container-custom max-w-6xl">
            ...
            <p className="text-center text-sm text-muted-foreground mt-6 italic">
              Modern, responsive website design highlighting A&P Renovations' craftsmanship and
              services.
            </p>
          </div>
        </section>
        ...
        <section className="section-padding">
          <div className="container-custom max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              A&P Renovations is an Ogden, Utah–based general contracting company specializing in
              full home remodels, kitchen and bathroom upgrades, and residential renovations. Known
              for their craftsmanship and reliability, they wanted to move beyond referrals and
              build a consistent pipeline of high-quality leads online.
            </p>
          </div>
        </section>
          ...
          <div className="container-custom max-w-4xl">
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p className="flex items-start gap-3">
                ...
                <span>
                  Outdated website with limited project storytelling and weak conversion paths
                </span>
              </p>
              <p className="flex items-start gap-3">
                <span className="text-primary mt-1">•</span>
              ...
              <p className="flex items-start gap-3">
                <span className="text-primary mt-1">•</span>
                <span>
                  Competitors outranking them for high-intent local keywords (e.g., "kitchen
                  remodel Ogden," "bathroom remodel Ogden")
                </span>
              </p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-primary">
                  Website & Brand Presentation
                </h3>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Built a clean, responsive site with before/after galleries, service pages, and
                  trust signals (reviews, badges, warranties). Clarified service areas (Ogden,
                  Weber County, Northern Utah) to match how customers search.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Optimized Google Business Profile (categories, services, photos, Q&A). On-page
                  SEO for priority keywords and neighborhoods. Created SEO-focused service pages and
                  location cues to support local intent.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Added prominent quote-request CTA, click-to-call, and short "Get a Bid" form. Set
                  up conversion tracking for calls, form submissions, and quote requests. Monthly
                  reporting with keyword movement, traffic, and lead outcomes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container-custom max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="card-premium p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  For multiple Ogden remodeling terms
                </p>
              </div>
        ...
        <section className="section-padding">
          <div className="container-custom max-w-4xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 items-start">
                <div className="font-bold text-primary min-w-[180px]">
          ...
          <div className="container-custom max-w-4xl">
            <div className="card-premium p-12">
              ...
              <p className="text-2xl mb-8 leading-relaxed text-muted-foreground">
                Market Integrators transformed how we get leads—within weeks we were ranking in
                Ogden and booking steady projects through the site.
              </p>
              <div>
